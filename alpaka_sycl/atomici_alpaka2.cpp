...
template<typename TAtomic, typename T, typename THierarchy>
...
template<typename T, typename THierarchy = hierarchy::Blocks>
auto atomicAdd(
//    TAtomic const&,
    T* const addr,
    T const& value,
...
{
    return atomicOp<AtomicAdd, T, THierarchy>(addr, value);
}
